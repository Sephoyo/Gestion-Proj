...
public final class Dates extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        cmdMo = new date.Button();
        cmdTu = new date.Button();
        cmdWe = new date.Button();
        cmdTh = new date.Button();
        cmdFr = new date.Button();
        cmdSa = new date.Button();
        cmdSu = new date.Button();
        ...
        cmd13 = new date.Button();
        cmd14 = new date.Button();
        cmd15 = new date.Button();
        cmd16 = new date.Button();
        cmd17 = new date.Button();
        cmd18 = new date.Button();
        cmd19 = new date.Button();
        cmd20 = new date.Button();
        cmd21 = new date.Button();
        cmd22 = new date.Button();
        cmd23 = new date.Button();
        cmd24 = new date.Button();
        cmd25 = new date.Button();
        cmd26 = new date.Button();
        cmd27 = new date.Button();
        cmd28 = new date.Button();
        cmd29 = new date.Button();
        cmd30 = new date.Button();
        cmd31 = new date.Button();
        cmd32 = new date.Button();
        cmd33 = new date.Button();
        cmd34 = new date.Button();
        cmd35 = new date.Button();
        cmd36 = new date.Button();
        cmd37 = new date.Button();
        cmd38 = new date.Button();
        cmd39 = new date.Button();
        cmd40 = new date.Button();
        cmd41 = new date.Button();
        cmd42 = new date.Button();
        ...
        cmdTu.setText("Ma");
        cmdTu.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cmdTuActionPerformed(evt);
            }
        });
        add(cmdTu);
        ...
        cmdSa.setForeground(new java.awt.Color(255, 1, 1));
        cmdSa.setText("Sa");
        add(cmdSa);
    ...
    private void cmdTuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdTuActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_cmdTuActionPerformed
    ...
    private date.Button cmd13;
    private date.Button cmd14;
    private date.Button cmd15;
    private date.Button cmd16;
    private date.Button cmd17;
    private date.Button cmd18;
    private date.Button cmd19;
    private date.Button cmd2;
    private date.Button cmd20;
    private date.Button cmd21;
    private date.Button cmd22;
    private date.Button cmd23;
    private date.Button cmd24;
    private date.Button cmd25;
    private date.Button cmd26;
    private date.Button cmd27;
    private date.Button cmd28;
    private date.Button cmd29;
    private date.Button cmd3;
    private date.Button cmd30;
    private date.Button cmd31;
    private date.Button cmd32;
    private date.Button cmd33;
    private date.Button cmd34;
    private date.Button cmd35;
    private date.Button cmd36;
    private date.Button cmd37;
    private date.Button cmd38;
    private date.Button cmd39;
    private date.Button cmd4;
    private date.Button cmd40;
    private date.Button cmd41;
    private date.Button cmd42;
    private date.Button cmd5;
    private date.Button cmd6;
    private date.Button cmd7;
    private date.Button cmd8;
    private date.Button cmd9;
    private date.Button cmdFr;
    private date.Button cmdMo;
    private date.Button cmdSa;
    private date.Button cmdSu;
    private date.Button cmdTh;
    private date.Button cmdTu;
    private date.Button cmdWe;
