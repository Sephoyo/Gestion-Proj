...
public final class DateChooser extends javax.swing.JPanel {
    ...
    private final String MONTH_ENGLISH[] = {"Janvier", "Février", "Mars", "Avril", "Mai", "Juin", "Juillet", "Aout", "Septembre", "Octobre", "Novembre", "Décembre"};
    ...
    public void setTextRefernceWD(JTextField txt) {
    this.textRefernce = txt;
    ...
    if (textRefernce != null) {
        ...
        this.textRefernce.addMouseListener(new MouseAdapter() {
            @Override
            public void mouseClicked(MouseEvent me) {
                // Vérifier si textRefernce est non nul et activé
                if (textRefernce != null && textRefernce.isEnabled()) {
                    showPopup();
                }
            }
        });
    ...
    private void initComponents() {
        ...
        cmdForward = new date.Button();
        MY = new javax.swing.JLayeredPane();
        cmdMonth = new date.Button();
        lb = new javax.swing.JLabel();
        cmdYear = new date.Button();
        cmdPrevious = new date.Button();
        slide = new date.Slider();
        ...
        cmdForward.setIcon(new javax.swing.ImageIcon(getClass().getResource("/date/forward.png")));
        ...
        cmdPrevious.setIcon(new javax.swing.ImageIcon(getClass().getResource("/date/previous.png")));
    ...
    private date.Button cmdForward;
    private date.Button cmdMonth;
    private date.Button cmdPrevious;
    private date.Button cmdYear;
    private javax.swing.JPanel header;
    private javax.swing.JLabel lb;
    private javax.swing.JPopupMenu popup;
    private date.Slider slide;
